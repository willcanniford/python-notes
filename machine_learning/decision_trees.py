...
# Load our data
# sklearn comes with datasets, but I've found this one on Kaggle that is
...
tree_model = DecisionTreeClassifier(
    max_depth=5, min_samples_leaf=5, max_features=3)
...
# The model is probably overfit since we haven't done a train/test split
# though...
